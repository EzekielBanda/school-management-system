...
const StudentForm = () => {
  ...
  return (
    <form className="mx-auto px-6 bg-gray-100 shadow-md" onSubmit={handleSubmit}>
      <div className='flex items-center mx-auto mb-5 shadow-sm border-cyan-100 border-b'>
        <h2 className="text-2xl">New Student</h2>
      </div>
      <div className='px-4 py-6 shadow-md bg-white border-t-2 border-blue-300 mb-6'>
      ...
      <div className="flex justify-center mt-4">
        ...
        <button type="button" className="ml-2 bg-gray-500 text-white px-4 py-2 rounded-md">
          Cancel
        </button>
      </div>
    </form>
